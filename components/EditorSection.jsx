...
const EditorSection = (props) => {
  ...
  return (
    <div className={'section' + (isActive ? ' active' : '')} style={{ transition: '500ms' }}>
      <div className="section-header" onClick={toggleActive} style={{ transition: '500ms' }}>
        {props.icon}
        {props.title}
      ...
      <div className="section-content" style={{ transition: '500ms' }}>{props.children}</div>
    </div>
  )
}
