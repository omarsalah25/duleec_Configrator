    ...
    return (
        <>
            {savedVehicleCount.length > 1 ? (
                ...
                <div style={{ color: 'black' }} className='dropdown' ref={dropdownRef}>
                    <strong style={{ color: 'black' }} onClick={() => setShowDropdown(!showDropdown)}>
                        {title}
                    ...
                    {showDropdown && (
                        <ul>
                            {Object.entries(savedVehicles).map(([vehicleId, vehicle]) => {
                                ...
                                return (
                                    <li style={{ color: 'black' }} key={vehicleId} onClick={() => handleVehicleSelect(vehicleId)}>
                                        {vehicle.name}
                                    </li>
                                )
                            })}
